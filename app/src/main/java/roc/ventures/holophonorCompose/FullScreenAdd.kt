...
import roc.ventures.holophonorCompose.databinding.ActivityFullScreenAddBinding
...
class FullScreenAdd : AppCompatActivity() {

    private var currentLevel: Int = 0
    private var interstitialAd: InterstitialAd? = null
    private lateinit var nextLevelButton: Button
    private lateinit var levelTextView: TextView
    private val TAG = "FullScreenAdd"
private lateinit var binding: ActivityFullScreenAddBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

     binding = ActivityFullScreenAddBinding.inflate(layoutInflater)
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.menu_full_screen_add, menu)
        return true
    }
      ...
      InterstitialAd.load(this, getString(R.string.interstitial_ad_unit_id), adRequest,
        object : InterstitialAdLoadCallback() {
          override fun onAdLoaded(ad: InterstitialAd) {
            ...
            Toast.makeText(this@FullScreenAdd, "onAdLoaded()", Toast.LENGTH_SHORT)
              .show()
